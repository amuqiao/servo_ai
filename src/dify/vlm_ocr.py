...
if __name__ == "__main__":
    ...
    # http://xuntian-ai-dev.tclpv.com/v1
    # 
    # app-fOOCPaHhxEMWXNwYstLtH89N
    
    # http://xuntian-ai-sit.tclpv.com/v1
    # app-FpC7jmVhoS90BTUSfCxsm0gG
    client = DifyClient(
        base_url="http://xuntian-ai-sit.tclpv.com/v1",  # 修改base_url为包含/v1的完整路径
        api_key="app-FpC7jmVhoS90BTUSfCxsm0gG"
    )
    
    # http://xuntian-ai.tclpv.com/v1
    # app-SbRWB5nC0lVqZ3x4UQtHX3db
    # client = DifyClient(
    #     base_url="https://xuntian-ai.tclpv.com",
    #     api_key="app-SbRWB5nC0lVqZ3x4UQtHX3db"
    # )
